!(function (e, t) {
  ...
  return (
    ...
    t(p, o),
    (p.prototype.fixDuration = function (e) {
      var t = this.getSectionById(139690087);
      if (!t)
        return (
          console.log("[fix-webm-duration] Segment section is missing"), !1
        );
      var n = t.getSectionById(88713574);
      if (!n)
        return console.log("[fix-webm-duration] Info section is missing"), !1;
      var a = n.getSectionById(710577);
      if (!a)
        return (
          console.log("[fix-webm-duration] TimecodeScale section is missing"),
          !1
        );
      var i = n.getSectionById(1161);
      if (i) {
        if (!(i.getValue() <= 0))
          return (
            console.log("[fix-webm-duration] Duration section is present"), !1
          );
        console.log(
        ...
        console.log("[fix-webm-duration] Duration section is missing"),
          (i = new r("Duration", "Float")).setValue(e),
          n.data.push({ id: 1161, data: i });
      return (
        a.setValue(1e6),
        n.updateByData(),
        t.updateByData(),
    ...
    function (e, t, n) {
      try {
        ...
        (a.onloadend = function () {
          try {
            var i = new p(new Uint8Array(a.result));
            i.fixDuration(t) && (e = i.toBlob());
          } catch (e) {}
          n(e);
        }),
